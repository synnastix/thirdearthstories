---
title: Smithing for Simpletons
category: lore
lead: "A beginners guide to metallurgy."
tags:
  - heartlands
  - timbur-deep
---

*Training material developed by the Emberforge Brotherhood to ensure repeatable quality across the metalworking guild. Authored by Master Camden, under tutelage of Grandmaster Tressian.*
...
Working copper is simple enough if one has access to the right tools. It can be cold-worked directly for basic shapes, but reheating to restore softness before working is the preferred method. It is an exceptional metal for vessels, fittings, and other simple items. It is much too soft for edged tools or weapons, and is therefore most suitable for domestic applications.

### Bronze

Bronze is not a natural material but rather a melding of materials – copper and tin. The material is mixed in a ratio that includes roughly nine parts copper, one part tin, though this can vary depending on the desired outcome. Combining the two creates a material much more durable than either alone, and is an excellent choice for forging weapons, tools, and other items where hardness matters.
...
Lead is another fantastic material for the apprentice because it is easy to identify and work with. It is found in silver-grey deposits with a bright luster when freshly broken or exposed, standing out in a way that even an untrained eye will notice. It smelts easily and can be worked cold. When purified of contaminants, in fact, one may be able to help shape the material simply by biting it, which cannot be said of most other metals. It is, however, too soft for most crafts and therefore the Brotherhood recommends focusing on other materials.
...
Gold is nearly useless structurally, however it is similar to silver in that it is highly desired as a decorative material. It has been used by master craftsmen as inlays in decorative swords and jewelry, though should never be considered as a primary material in anything destined for combat. It forges similar to copper, and works much the same. In its raw form it can be found sometimes in riverbeds and readily identified by its luster. The gods certainly must find it humorous to find humans so entranced by something that is quite literally washed from the mountains as debris.

## Other Materials

### Obsidian

This material receives special mention due to its commonality within the mountains close to Timbur Deep and sharpness. It is not a metal, and not quite stone, but something more like glass. It may, in fact, be the sharpest option for making blades among the materials discussed. However, it is very brittle and prone to chipping, and must be knapped into shape rather than forged. The chips themselves are also very sharp and obsidian knapping can be quite dangerous. The old saying holds true:  

*If you didn’t learn knapping as a child then your father failed you. If you didn’t learn how to knap obsidian as a child, your father loved you.*

Thus when considering something such as an arrowhead, obsidian makes a great choice for hunting but poor choice for warriors. Metal arrowheads of iron or bronze are a superior option in most circumstances.
